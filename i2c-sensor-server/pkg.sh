...
project='mu2e-tracker-i2c-sensor-tools'
...
python="${lib}/python3/dist-packages/I2CSensorConnection"
...
server="./i2c-sensor-server.py"
binary="${bin}/i2c-sensor-server"
module='../Client/I2CSensorConnection.py'
service='../systemd/i2c-sensor-server.service'
starget="${syd}/i2c-sensor-server.service"
envfile='./i2c-sensor.env'
etarget="${etc}/i2c-sensor.env"
