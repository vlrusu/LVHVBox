...
project='mu2e-tracker-network-watch'
...
server="./network-watch.py"
binary="${bin}/network-watch"
service='../systemd/network-watch.service'
starget="${syd}/network-watch.service"
envfile='./network-watch.env'
etarget="${etc}/network-watch.env"
